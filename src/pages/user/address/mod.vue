    ...
    export default {
        ...
        methods:{
            ...mapActions({
                ...
                asycDelAddress:"address/delAddress"
            }),
            submit(){
                ...
                if(this.isSubmit){
                    this.isSubmit=false;
                    this.modAddress({aid:this.aid,name:this.name,cellphone:this.cellphone,province:this.province,city:this.city,area:this.area,address:this.address,isdefault:this.isDefault?"1":"0",success:(res)=>{
                            if(res.code===200){
                                Toast({
                                    duration:2000,
                                    message:"修改成功",
            ...
            delAddress(){
                Dialog.confirm({
                    ...
                    this.asycDelAddress({aid:this.aid});
                    this.$router.go(-1);
                }).catch(()=>{
