<template>
    <div class="page">
        ...
        <div class='main'>
            ...
            <ul class='list'>
                <li>性别</li>
                <li><input type="text" placeholder="请选择性别" readonly  :value="showGender" @click="isGender=true"/></li>
                <li class='arrow'></li>
            </ul>
        </div>
        <van-action-sheet
    ...
    export default {
        ...
        methods:{
            ...mapActions({
                ...
                updataUserInfo:"user/updataUserInfo",
            ...
            submit(){
                ...
                if(this.isSubmit){
                    this.isSubmit=false;
                    this.updataUserInfo({nickname:this.nickname,gender:this.gender,head:this.head,success:(res)=>{
                            if(res.code===200){
                                Toast({
                                    message:"修改成功！",
                                    duration:1000,
