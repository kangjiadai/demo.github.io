    ...
    <div class="page">
        ...
        <div class='main'>
            ...
            <div class='cellphone-wrap'>
                <div class='cellphone'><input type="text" placeholder="请输入手机号" @input="checkCellPhone" v-model="cellphone"/></div>
    ...
    export default {
        ...
        methods: {
            ...
            async submit(){
                ...
                let vcodeData = await this.checkCode({vcode: this.vcode});
        ...
        beforeDestroy(){//性能优化
            clearInterval(this.timer);//页面离开时清除定时器
        }
    }
</script>
